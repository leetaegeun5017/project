...
public class MainActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 카메라 전면 후면 전환
        Button camera_change_button = findViewById(R.id.btn_reverse);
        camera_change_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button album_button = findViewById(R.id.btn_album);
